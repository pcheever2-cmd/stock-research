#!/usr/bin/env python3
"""
Backtest Compass Score with Quality Filters (OPTIMIZED)
========================================================
Compares Compass Score performance with and without quality filters.

OPTIMIZATIONS:
- Pre-computes ALL forward returns once (major speedup)
- Pre-computes ALL volatilities once (major speedup)
- Reduces runtime from ~50 hours to ~8-10 hours (80% faster)
